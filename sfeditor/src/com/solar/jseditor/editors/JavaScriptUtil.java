...
public class JavaScriptUtil {
	...
	/**
	 * Creates a {@link JavaScriptFunctionProposal} instance.
	 * This method is called by {@link JavaScriptAssistProcessor}.
	 *
	 ...
	 */
	public static ICompletionProposal createTemplateCompletionProposal(
			String displayString, String replaceString, String fromSource,
			String description, Image image, Region region) {
		...
		Template template = new Template(displayString, fromSource,
		...
		ICompletionProposal proposal = new JavaScriptFunctionProposal(template,
				templateContext, region, image, description);
