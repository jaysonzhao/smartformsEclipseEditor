...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Lcom.solar.jseditor.rhino/javascript/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Lcom.solar.jseditor.rhino/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Lcom.solar.jseditor.rhino/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName)
    {
        cfw.startMethod("<init>",
                        "(Lcom.solar.jseditor.rhino/javascript/ContextFactory;"
                        +"Lcom.solar.jseditor.rhino/javascript/Scriptable;)V",
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com.solar.jseditor.rhino/javascript/JavaAdapter",
                                          ...
                                          String scriptClassName)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com.solar.jseditor.rhino/javascript/JavaAdapter",
                      "runScript",
                      "(Lcom.solar.jseditor.rhino/javascript/Script;"
                      +")Lcom.solar.jseditor.rhino/javascript/Scriptable;");
                                     ...
                                     boolean callConvertResult)
    {
        ...
        if (retType == Void.TYPE) {
            ...
            cfw.addInvoke(ByteCode.INVOKESTATIC,
                          "com.solar.jseditor.rhino/javascript/Context",
                                       ...
                                       Class<?> returnType)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "(Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                      +"Ljava/lang/String;"
                      +")Lcom.solar.jseditor.rhino/javascript/Function;");
