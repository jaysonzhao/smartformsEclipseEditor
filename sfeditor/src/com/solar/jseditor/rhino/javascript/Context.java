...
import com.solar.jseditor.rhino.javascript.debug.DebuggableScript;
import com.solar.jseditor.rhino.javascript.debug.Debugger;
...
public class Context
{
    ...
    public static void addContextListener(ContextListener listener)
    {
        ...
        String DBG = "com.solar.jseditor.rhino.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "com.solar.jseditor.rhino.javascript.ContextFactory");
     ...
     *
     * @see com.solar.jseditor.rhino.javascript.ErrorReporter
     */
     ...
     * @see com.solar.jseditor.rhino.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (com.solar.jseditor.rhino.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see com.solar.jseditor.rhino.javascript.Script
     */
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "com.solar.jseditor.rhino.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "com.solar.jseditor.rhino.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "com.solar.jseditor.rhino.javascript.regexp.RegExpImpl");
            if (cl != null) {
