...
package com.solar.jseditor.rhino.javascript.optimizer;
...
import com.solar.jseditor.rhino.classfile.ByteCode;
import com.solar.jseditor.rhino.classfile.ClassFileWriter;
import com.solar.jseditor.rhino.javascript.CompilerEnvirons;
import com.solar.jseditor.rhino.javascript.Context;
import com.solar.jseditor.rhino.javascript.Evaluator;
import com.solar.jseditor.rhino.javascript.Function;
import com.solar.jseditor.rhino.javascript.FunctionNode;
import com.solar.jseditor.rhino.javascript.GeneratedClassLoader;
import com.solar.jseditor.rhino.javascript.Kit;
import com.solar.jseditor.rhino.javascript.NativeFunction;
import com.solar.jseditor.rhino.javascript.NativeGenerator;
import com.solar.jseditor.rhino.javascript.Node;
import com.solar.jseditor.rhino.javascript.ObjArray;
import com.solar.jseditor.rhino.javascript.ObjToIntMap;
import com.solar.jseditor.rhino.javascript.RhinoException;
import com.solar.jseditor.rhino.javascript.Script;
import com.solar.jseditor.rhino.javascript.ScriptOrFnNode;
import com.solar.jseditor.rhino.javascript.ScriptRuntime;
import com.solar.jseditor.rhino.javascript.Scriptable;
import com.solar.jseditor.rhino.javascript.SecurityController;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "com.solar.jseditor.rhino.javascript.gen.c"+serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("com.solar.jseditor.rhino/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "com.solar.jseditor.rhino/javascript/BaseFunction",
                      "createObject",
                      "(Lcom.solar.jseditor.rhino/javascript/Context;"
                      +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                      +")Lcom.solar.jseditor.rhino/javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "com.solar.jseditor.rhino/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "com.solar.jseditor.rhino/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com.solar.jseditor.rhino/javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Lcom.solar.jseditor.rhino/javascript/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "com.solar.jseditor.rhino/javascript/ScriptRuntime",
                      "doTopCall",
                      "(Lcom.solar.jseditor.rhino/javascript/Callable;"
                      +"Lcom.solar.jseditor.rhino/javascript/Context;"
                      +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                      +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Lcom.solar.jseditor.rhino/javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "com.solar.jseditor.rhino/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Lcom.solar.jseditor.rhino/javascript/Context;"
                      +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                      +")V");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "com.solar.jseditor.rhino/javascript/RegExpProxy",
                              "compileRegExp",
                              "(Lcom.solar.jseditor.rhino/javascript/Context;"
                         ...
                         int contextArg, int scopeArg)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Lcom.solar.jseditor.rhino/javascript/Context;"
                      +")Lcom.solar.jseditor.rhino/javascript/RegExpProxy;");
        // Stack: proxy, array
        cfw.add(ByteCode.DUP);
        cfw.addALoad(contextArg);
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "com.solar.jseditor.rhino/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "com.solar.jseditor.rhino/javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptOrFnNode n)
    {
        ...
        sb.append("Lcom.solar.jseditor.rhino/javascript/Context;"
                  +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                  +"Lcom.solar.jseditor.rhino/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Lcom.solar.jseditor.rhino/javascript/Scriptable;"
          +"Lcom.solar.jseditor.rhino/javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
                ...
                || fnCurrent.fnode.getIgnoreDynamicScope()))
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "com.solar.jseditor.rhino/javascript/Scriptable",
                          "getParentScope",
                          "()Lcom.solar.jseditor.rhino/javascript/Scriptable;");
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Lcom.solar.jseditor.rhino/javascript/NativeFunction;"
                               +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Lcom.solar.jseditor.rhino/javascript/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Lcom.solar.jseditor.rhino/javascript/NativeFunction;"
                               +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                               +"Lcom.solar.jseditor.rhino/javascript/Scriptable;II"
                               +")Lcom.solar.jseditor.rhino/javascript/Scriptable;");
    ...
    private void generateActivationExit()
    {
        ...
        addScriptRuntimeInvoke("exitActivationFunction",
                               "(Lcom.solar.jseditor.rhino/javascript/Context;)V");
    }
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "com.solar.jseditor.rhino/javascript/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Lcom.solar.jseditor.rhino/javascript/Context;"
                    +")Lcom.solar.jseditor.rhino/javascript/Ref;");
                break;
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Lcom.solar.jseditor.rhino/javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                            +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Lcom.solar.jseditor.rhino/javascript/Callable;"
                            +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                            +"Lcom.solar.jseditor.rhino/javascript/Context;"
                            +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "com.solar.jseditor.rhino/javascript/Callable",
                "call",
                "(Lcom.solar.jseditor.rhino/javascript/Context;"
                +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                +"Lcom.solar.jseditor.rhino/javascript/Scriptable;"
                                    ...
                                    int exceptionLocal)
    {
        ...
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            exceptionName = "com.solar.jseditor.rhino/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            exceptionName = "com.solar.jseditor.rhino/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            exceptionName = "com.solar.jseditor.rhino/javascript/EcmaError";
