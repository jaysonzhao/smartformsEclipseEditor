 ...
 * <pre>
 * import com.solar.jseditor.rhino.javascript.*;
 *
...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link com.solar.jseditor.rhino.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected com.solar.jseditor.rhino.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return com.solar.jseditor.rhino.javascript.xml.XMLLib.Factory.create(
                "com.solar.jseditor.rhino.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return com.solar.jseditor.rhino.javascript.xml.XMLLib.Factory.create(
                "com.solar.jseditor.rhino.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
