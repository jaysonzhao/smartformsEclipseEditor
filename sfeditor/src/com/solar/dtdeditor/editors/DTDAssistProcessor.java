...
public class DTDAssistProcessor extends HTMLAssistProcessor {
	...
	private static ICompletionProposal createProposal(String text, String display, String word, int offset, int position, String image){
	...
	/* (non-Javadoc)
	 * @see com.solar.htmleditor.assist.HTMLAssistProcessor#enableTemplate()
	 */
